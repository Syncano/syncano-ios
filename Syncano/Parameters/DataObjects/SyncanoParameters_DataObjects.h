 ...
 */
@interface SyncanoParameters_DataObjects_New : SyncanoParameters_DataObjects_State_Validate
/**
 Project id
 */
@property (strong)  NSString *projectId;
...
/**
 If specified, creates one parent-child relation with specified parent id.
 */
 ...
 */
@interface SyncanoParameters_DataObjects_Update : SyncanoParameters_ProjectId_CollectionId_CollectionKey_State_Validate
/**
...
/**
 Source URL associated with message.
 */
@property (strong)    NSString *source_url;
/**
 Title of message.
 */
@property (strong)    NSString *title;
...
@property (strong)    NSString *projectId;
/**
 Collection id or key defining collection containing data.
 */
@property (strong)    NSString *collectionId;
@property (strong)    NSString *collectionKey;
/**
...
@property (strong)    NSArray *data_ids;
@property (strong)    NSArray *folders;
@property (strong)    NSString *by_user;
@property (strong)    NSNumber *limit;
@property (strong, nonatomic)    NSString *filter;
