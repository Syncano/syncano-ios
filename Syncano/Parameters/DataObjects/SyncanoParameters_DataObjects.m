...
- (NSArray *)initalizeSelectorNamesArray {
    return @[@"initWithProjectId:collectionId:dataId:", @"initWithProjectId:collectionId:dataKey:",
             @"initWithProjectId:collectionKey:dataId:", @"initWithProjectId:collectionKey:dataKey:"];
}
...
- (SyncanoParameters_DataObjects_RemoveChild *)initWithProjectId:(NSString *)projectId collectionId:(NSString *)collectionId dataId:(NSString*)dataId  {
    ...
    if (self) {
        ...
        self.data_id = dataId;
        [self validateSpecialParameters:@[@"project_id", @"collection_id", @"data_id"]];
    }
    return self;
}
...
- (SyncanoParameters_DataObjects_RemoveChild *)initWithProjectId:(NSString *)projectId collectionKey:(NSString *)collectionKey dataId:(NSString*)dataId{
    ...
    if (self) {
        ...
        self.data_id = dataId;
        [self validateSpecialParameters:@[@"project_id", @"collection_key", @"data_id"]];
    }
    return self;
}
