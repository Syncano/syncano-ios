...
- (SyncanoResponse *)sendRequest:(SyncanoParameters *)params {
    ...
    dispatch_semaphore_t semaphore = dispatch_semaphore_create(0);
    id <SyncanoRequest> request = [self getRequest:params operationManager:self.synchronousOperationManager success: ^(id < SyncanoRequest > request, SyncanoResponse *response) {
...
NSString *const KDefaultVersionNumber = @"3.1.35";
