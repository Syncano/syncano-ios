...
//                __block NSError *_error;
//                __block BOOL _blockFinished;
//                NSURLSessionDataTask *task = [apiClient POSTWithPath:@"PATH" params:@{@"param" : @"value"} completion:^(NSURLSessionDataTask *task, id responseObject, NSError *error) {
//                    _error = error;
//                    _blockFinished = YES;
//                }];
//                [[expectFutureValue(theValue(_blockFinished)) shouldEventually] beYes];
...
//                __block NSError *_error;
//                __block BOOL _blockFinished;
//                NSURLSessionDataTask *task = [apiClient PUTWithPath:@"PATH" params:@{@"param" : @"value"} completion:^(NSURLSessionDataTask *task, id responseObject, NSError *error) {
//                    _error = error;
//                    _blockFinished = YES;
//                }];
//                [[expectFutureValue(theValue(_blockFinished)) shouldEventually] beYes];
...
//                __block NSError *_error;
//                __block BOOL _blockFinished;
//                NSURLSessionDataTask *task = [apiClient PATCHWithPath:@"PATH" params:@{@"param" : @"value"} completion:^(NSURLSessionDataTask *task, id responseObject, NSError *error) {
//                    _error = error;
//                    _blockFinished = YES;
//                }];
//                [[expectFutureValue(theValue(_blockFinished)) shouldEventually] beYes];
...
//                __block NSError *_error;
//                __block BOOL _blockFinished;
//                NSURLSessionDataTask *task = [apiClient DELETEWithPath:@"PATH" params:@{@"param" : @"value"} completion:^(NSURLSessionDataTask *task, id responseObject, NSError *error) {
//                    _error = error;
//                    _blockFinished = YES;
//                }];
//                [[expectFutureValue(theValue(_blockFinished)) shouldEventually] beYes];
